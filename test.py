...
videocapture=cv2.VideoCapture("http://192.168.0.105:8080/video")
...
cv2.createTrackbar("threshold", windowName, 172, 255, nothing)
cv2.createTrackbar("kernel", windowName, 15, 30, nothing)
